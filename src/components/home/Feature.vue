      ...
      <div class="row">
        <div class="col-12 col-lg-4 col-md-6">
          <div class="position-relative rounded overflow-hidden"> 
            <!-- Background --> 
            <img class="img-fluid hover-zoom" src="../../../static/assets/images/product-ad/01.jpg" alt=""> 
            <!-- Body -->
        ...
        <div class="col-12 col-lg-4 col-md-6 mt-5 mt-md-0">
          <div class="position-relative rounded overflow-hidden"> 
            <!-- Background --> 
            <img class="img-fluid hover-zoom" src="../../../static/assets/images/product-ad/02.jpg" alt=""> 
            <!-- Body -->
            <div class="position-absolute top-50 pl-5">
        ...
        <div class="col-12 col-lg-4 col-md-12 mt-5 mt-lg-0 d-md-none d-lg-block">
          <div class="position-relative rounded overflow-hidden"> 
            <!-- Background --> 
            <img class="img-fluid hover-zoom" src="../../../static/assets/images/product-ad/03.jpg" alt=""> 
            <!-- Body -->
            <div class="position-absolute top-50 pl-5">
