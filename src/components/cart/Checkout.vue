	...
	<div class="container">
      ...
      <div class="col-md-12">
        <div class="tab product-tab">
          <!-- Nav tabs -->
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist"> <a class="nav-item nav-link active ml-0" id="nav-tab1" data-toggle="tab" href="#tab3-1" role="tab" aria-selected="true">Registerd User</a>
              <a class="nav-item nav-link" id="nav-tab2" data-toggle="tab" href="#tab3-2" role="tab" aria-selected="false">Guest User</a>
         ...
         <div class="store-name">SIGN IN</div>
          ...
          <div class="d-flex align-items-center text-center justify-content-center mt-4">
                ...
                <div class="col-md-6">
                 <div class="row shadow p-6 bg-white">
                 	   <div class="col-lg-12 col-md-12 p-0">
        <div class="mb-6">
           <h2 class="font-w-6 text-uppercase">Create New Account</h2>
        </div>
        </div>
